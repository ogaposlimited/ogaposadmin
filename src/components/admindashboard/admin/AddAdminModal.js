...
// const AddAdminModal = ({ showModal, setShowModal, updateTableData }) => {
...
//   // useEffect(() => {
//   //   // Fetch points when the modal is shown
//   //   if (showModal) {
//   //     const fetchPoints = async () => {
//   //       try {
//   //         const response = await axios.get(`${apiUrl}/api/point`);
//   //         setPoints(response.data); // Assuming the data is an array of points
//   //       } catch (error) {
...
//         try {
//           const response = await axios.get(`${apiUrl}/api/point`);
//           console.log("Fetched points:", response.data); // Log the fetched points to the console
//           setPoints(response.data); // Assuming the data is an array of points
//         } catch (error) {
//           console.error("Error fetching points:", error);
//         }
...
//         pointIds: [selectedPoint], // Send selected point ID
//       });
...
//                 <div className="form-group">
//                   <label htmlFor="point">Assign Point</label>
//                   <select
//                     className="form-control"
//                     id="point"
//                     name="point"
...
//                     style={{ color: selectedPoint ? "black" : "white" }} // Text color depends on selection
//                     required
//                   >
...
//                           key={point?._id}
//                           value={point?._id}
//                           style={{ color: "black" }} // Default text color for options
//                         >
//                           {point?.pointname}
//                         </option>
//                       ))}
