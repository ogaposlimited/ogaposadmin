              ...
              <div class="welcome d-lg-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center welcome-text">
                  <h3 class="d-flex align-items-center">
                    <img
                      src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/hi.svg"
                      alt="img"
                    />
                    &nbsp;Hi John Smilga,
                  </h3>
              ...
              <div class="row sales-cards">
                <div class="col-xl-6 col-sm-12 col-12">
                  <div class="card d-flex align-items-center justify-content-between default-cover mb-4">
                    <div>
                      ...
                      <h3>
                        $
                        <span class="counters" data-count="95000.45">
                          95000.45
                        </span>
                      </h3>
                      <p class="sales-range">
                    ...
                    <img
                      src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/weekly-earning.svg"
                      alt="img"
                    />
                  </div>
                </div>
                <div class="col-xl-3 col-sm-6 col-12">
                  <div class="card color-info bg-primary mb-4">
                    <img
                      src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/total-sales.svg"
                      alt="img"
                    />
                    <h3 class="counters" data-count="10000.00">
                      10,000+
                    </h3>
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                  <div class="card color-info bg-secondary mb-4">
                    <img
                      src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/purchased-earnings.svg"
                      alt="img"
                    />
                    <h3 class="counters" data-count="800.00">
                      800+
                    </h3>
                    <p>No of Total Sales</p>
                    <i
                            ...
                            <tr>
                              <td>
                                <div class="product-info">
                                  ...
                                  >
                                    <img
                                      src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/products/stock-img-04.png"
                                      alt="product"
                                    />
                                  </a>
                                  <div class="info">
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="product-info">
                                  ...
                                  >
                                    <img
                                      src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/products/stock-img-05.png"
                                      alt="product"
                                    />
                                  </a>
                                  <div class="info">
